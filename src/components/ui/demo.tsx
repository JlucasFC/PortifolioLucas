...
export function SplineSceneBasic() {
  return (
    <Card className="relative flex min-h-screen max-h-screen w-full overflow-hidden border-slate-800 bg-black/[0.96] px-6">
      ...
      <div className="flex min-h-screen h-full flex-col md:flex-row">
        <div className="relative z-10 flex flex-1 flex-col justify-center p-8">
          <h2 className="bg-gradient-to-b from-neutral-50 to-neutral-400 bg-clip-text text-3xl font-bold text-transparent md:text-4xl">desenvolvedor full stack</h2>
